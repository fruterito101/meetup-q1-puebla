  ...
  const tracks = [
    {
      ...
      duration: "45 min",
      description: "Ethereum Onboarding: Core concepts and initial network setup",
    ...
    },
    {
      ...
      duration: "45 min",
      description: "Liquidity mechanics and emerging financial tools",
    ...
    },
    {
      ...
      duration: "45 min",
      description: "Tools for on-chain analysis and coding optimization",
    ...
    },
    {
      ...
      duration: "45 min",
      description: "The networking space featured golden tacos, potato wedges, fries, popcorn, and snacks. Beer, soft drinks, and water were available to keep conversations flowing. The vibe encouraged attendees to exchange contacts and ask technical questions after the talks.",
